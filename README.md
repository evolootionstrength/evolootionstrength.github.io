...
# Terms of Use (EULA)
Evolootion Strength and Conditioning app is an app that provides programming and guidance with exercise description videos. However, this is still an app, and it cannot provide guidance on your perceived or actual training level. If the user is unsure of how to utilize the app, is unsure of the appropriate weight to use, and is unsure of how to perform the exercises correctly, you should consult a training professional to assist you with your guidance. 

Injury and possible death can occur when strength training. Although Evolootion Strength and Conditioning app is an exercise training app with instructional videos on how to do the exercises correctly, there is still a chance that injury can occur. Exercises done beyond your training ability can result in injury or death. Evolootion Strength and Conditioning will not be held liable if injury does occur while using the app. By using this app you are understanding that exercises can come with inherent risk. 


If you have any pre-existing health conditions, consult your physician before using this app.

Evolootion App does not share any data with other sources. The only data collected is for the purpose of billing and the user's workout programs within the app. If you have any questions or concerns, you can contact us at evolootionllc@gmail.com 
